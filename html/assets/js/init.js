  ...
  window.addEventListener('message', function( event ) {
	...
	if (event.data.action == 'open') {
	  ...
	  if ( type == 'identification' || type == null || type == "drivers_license") {
		...
		$('img').attr('src', mugshot);
		$('#expiry').text(metadata.expireson);
		$('#id-card').css('background', 'url(assets/images/firearms.png)');
	  } else if ( type == 'police_license' ) {
		$('img').show();
		$('#idnum').text(metadata.citizenid);
		$('#name').css('color', '#282828');
		$('#fname').css('color', '#282828');
		...
		$('img').attr('src', mugshot);
		$('#expiry').text(metadata.expireson);
		$('#id-card').css('background', 'url(assets/images/police.png)');
	  } else if ( type == 'ems_license' ) {
		$('img').show();
		$('#idnum').text(metadata.citizenid);
		$('#name').css('color', '#282828');
		$('#fname').css('color', '#282828');
		...
		$('img').attr('src', mugshot);
		$('#expiry').text(metadata.expireson);
		$('#id-card').css('background', 'url(assets/images/ems.png)');
	} else if ( type == 'ems_mechanic' ) {
		$('img').show();
		$('#idnum').text(metadata.citizenid);
		$('#name').css('color', '#282828');
		$('#fname').css('color', '#282828');
		...
		$('img').attr('src', mugshot);
		$('#expiry').text(metadata.expireson);
		$('#id-card').css('background', 'url(assets/images/mechanic.png)');
	  }
